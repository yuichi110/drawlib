...
The **Preset Styles** section covers Drawlib's built-in style presets and custom style management.

---

## Preset Styles Documentation

- [Official Default Preset Styles](./official_default.md): Default style catalog and color variations.
