...
<figure class="drawlib-image" style="text-align: center;">
  <img src="official_default_images/1.png" alt="official_default_1" style="width: 600px; max-width: 100%;" />
  <figcaption class="drawlib-caption">Preset styles default color chart</figcaption>
</figure>
