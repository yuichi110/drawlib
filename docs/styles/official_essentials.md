...
<figure class="drawlib-image" style="text-align: center;">
  <img src="official_essentials_images/1.png" alt="official_essentials_1" style="width: 650px; max-width: 100%;" />
  <figcaption class="drawlib-caption">Preset styles essentials color chart</figcaption>
</figure>
