...
def center():
    ...
    text((x + 8.5, 27), "doc.md", style=ts_left)
    line((x + 3, 27), (x + 4, 27), style=line_thin)
    icon_phosphor.file_image((x + 6, 24), width=3, style=icon_thin_red)
    text((x + 8.5, 24), "img1.png", style=ts_left_red)
    line((x + 3, 24), (x + 4, 24), style=line_thin)
    icon_phosphor.file_image((x + 6, 21), width=3, style=icon_thin_red)
...
def right():
    ...
    icon_phosphor.file_pdf((85, 43), width=6, style=icon_thin)
    icon_phosphor.file_html((85, 35), width=6, style=icon_thin)
    icon_phosphor.file_ppt((85, 27), width=6, style=icon_thin)
    icon_phosphor.book_bookmark((85, 19), width=6, style=icon_thin)
...
def bottom():
    ...
    icon_phosphor.github_logo((17, 5), width=5, style=icon_thin)
    text(
        (53, 5),
