...
```drawlib 500px center caption:"2D Cartesian Coordinate System with Bottom-Left Origin (0,0)"
...
```drawlib 500px center caption:"Canvas with Custom Styled Grid Overlay"
from drawlib.canvas import config
from drawlib.colors import Colors, Colors140
...
```drawlib 500px center caption:"Widescreen 16:9 Aspect Ratio Canvas (width=160, height=90)"
from drawlib.canvas import config
...
```drawlib 500px center caption:"Canvas with Custom Background Color and Opacity"
from drawlib.canvas import config
from drawlib.colors import Colors140
from drawlib.shapes import circle
from drawlib.text import text
