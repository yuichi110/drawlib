...
$DRAWLIB_CMD build markdown __SRC_DIR__/ -o __OUT_DIR__/

echo "Building HTML site..."
$DRAWLIB_CMD build html __SRC_DIR__/ -o __OUT_HTML_DIR__/

echo "Build complete!"
echo "  - Markdown: __OUT_DIR__/"
echo "  - HTML: __OUT_HTML_DIR__/"
