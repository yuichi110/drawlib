...
class TestShapeUtil:
    ...
    def test_format_styles(self) -> None:
        ...
        def get_shape_style(name: str = "") -> ShapeStyle:
            if name == "custom_shape":
                return ShapeStyle(line_width=15.0)
            return ShapeStyle(line_width=5.0)

        def get_text_style(name: str = "") -> ShapeTextStyle:
            if name == "custom_text":
                return ShapeTextStyle(text_size=40)
            return ShapeTextStyle(text_size=20)
        ...
        custom_s = ShapeStyle(line_width=25.0)
        custom_t = ShapeTextStyle(text_size=50)
    ...
    def test_apply_alignment(self) -> None:
        ...
        style = ShapeStyle(text_halign=None, text_valign=None)
    ...
    def test_get_shape_text(self) -> None:
        ...
        style = ShapeTextStyle(text_size=12, text_angle=45.0, text_flip=True, text_xy_shift=(5.0, 10.0))
        ...
        abs_style = ShapeTextStyle(text_xy_abs_shift=(3.0, -3.0))
