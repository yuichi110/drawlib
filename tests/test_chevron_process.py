...
class TestChevronProcessRendering:
    ...
    def test_render_with_descriptions(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            cp = ChevronProcess(corner_angle=50.0, spacing=2.0)
    ...
    def test_render_flat_left_end(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            cp = ChevronProcess(flat_left_end=True, spacing=1.2)
    ...
    def test_render_custom_styles_and_palette(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            cp = ChevronProcess(palette=palette)
            cp.append("Alpha")
            cp.append(
                "Beta",
                style=Style(fill_color=(239, 68, 68, 1.0), line_width=1.5),
            )
            cp.append("GA")
