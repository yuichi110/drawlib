...
class TestGuarded:
    ...
    def test_guarded_developer_mode_propagates_exception(self):
        ...
        with patch("drawlib.v0_2.private.l1_core._settings.dutil_settings.is_developer_debug_mode", return_value=True):
    ...
    def test_guarded_non_developer_mode_intercepts_exception(self):
        ...
        with patch("drawlib.v0_2.private.l1_core._settings.dutil_settings.is_developer_debug_mode", return_value=False):
