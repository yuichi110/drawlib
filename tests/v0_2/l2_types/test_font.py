...
from drawlib.v0_2.private.l2_types_._font import TypeFont
...
class TestFontType:
    ...
    def test_type_font_validation(self):
        ...
        with (
            patch("drawlib.v0_2.private.l2_models_._font.get_script_relative_path", return_value="/dummy/font.ttf"),
