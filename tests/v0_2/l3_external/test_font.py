...
from drawlib.v0_2.private.l3_external._font import download_all_fonts, purge_font_cache
...
class TestPurgeFontCache:
    ...
    def test_purge_font_cache(self, tmp_path: Path):
        ...
        with (
            patch("drawlib.v0_2.private.l3_external._font.FONT_DIR_PATH", str(font_dir)),
            patch("drawlib.v0_2.private.l3_external._font.FONT_ICON_DIR_PATH", str(font_icon_dir)),
        ):
            purge_font_cache()
