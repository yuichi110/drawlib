...
from drawlib.v0_2.private.l3_fonts import FontSansSerif
from drawlib.v0_2.private.l3_styles import Colors, ShapeTextStyle, TextStyle
...
class TestTextUtil:
    ...
    def test_format_style(self) -> None:
        ...
        assert formatted_none.size == dtheme.textstyles.get().size

        # 2. Test string style lookup
        formatted_str = TextUtil.format_style("blue")
        assert formatted_str.color == dtheme.textstyles.get("blue").color

        # 3. Test TextStyle object (deep copied and merged)
        custom_style = TextStyle(size=32.0, color=(255, 0, 0))
        formatted_obj = TextUtil.format_style(custom_style)
        assert formatted_obj.size == 32.0
        assert formatted_obj.color == (255, 0, 0)
    ...
    def test_get_text_options(self) -> None:
        ...
        style = TextStyle(color=(0, 255, 0), halign="center", valign="top")
    ...
    def test_get_font_properties(self) -> None:
        ...
        font_path = "/Users/yuichi/GitHub/drawlib/src/drawlib/assets/v0_2/fonts/roboto/regular.ttf"
        font_file = FontFile(font_path)
        style_file = TextStyle(font=font_file, size=18.0)
        ...
        style_sans = ShapeTextStyle(font=FontSansSerif.LATO_REGULAR, size=15.0)
        ...
        with pytest.raises(ValueError):
            ...
            invalid_font_style = TextStyle(font=123, size=12.0)  # type: ignore
    ...
    def test_get_bbox_dict(self) -> None:
        ...
        transparent_style = TextStyle(bgfcolor=None, bglcolor=None, bglstyle="solid")
